# 00012-modspath-outputpath.ps1
# Functional test: Use both custom mods and output paths

$ErrorActionPreference = "Stop"

$TestName = "00012-modspath-outputpath"
...
& "../hash.ps1" -ModsPath "../mods" -OutputPath $versionedDir *>&1 | Tee-Object -FilePath $tempLog
