# 00009-updateconfig-bannedmodsmessage.ps1
# Functional test: Update IAC config with custom banned mods message

$ErrorActionPreference = "Stop"

$TestName = "00009-updateconfig-bannedmodsmessage"
...
& "../hash.ps1" -UpdateConfig -BannedModsMessage 'Banned Mods:' -ModsPath "../mods" -OutputPath $versionedDir *>&1 | Tee-Object -FilePath $tempLog
