# 00008-updateconfig-modpackmessage.ps1
# Functional test: Update IAC config with custom modpack message

$ErrorActionPreference = "Stop"

$TestName = "00008-updateconfig-modpackmessage"
...
& "../hash.ps1" -UpdateConfig -ModpackMessage 'Required Mods:' -ModsPath "../mods" -OutputPath $versionedDir *>&1 | Tee-Object -FilePath $tempLog
