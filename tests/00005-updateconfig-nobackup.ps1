# 00005-updateconfig-nobackup.ps1
# Functional test: Update IAC config without backup

$ErrorActionPreference = "Stop"

$TestName = "00005-updateconfig-nobackup"
...
& "../hash.ps1" -UpdateConfig -ModsPath "../mods" -OutputPath $versionedDir *>&1 | Tee-Object -FilePath $tempLog
